/**
 * This java file consists a class which creates 
 * the GUI  for case when data is moveing from Delimited AIF 
 * to Delimited AIF
 */
package sasco;
...
/**
 * This class  creates the GUI for the case when data is 
 * moving from Delimited AIF to Delimited AIF
 * @author Pulikit Saxena
 * @version 1.0
 *
 */
class GuiScripterDlmToDlm extends JFrame {
    JLabel lblSrcDml;
    JLabel lblTrgDml;
    JTextArea txtAreaSrcDml;
    JTextArea txtAreaTrgDml;
    JButton btnGenCodeDlmToDlm;
	JPanel panel;
	Container cnt;
	/**
	 ...
	 */
	public GuiScripterDlmToDlm(String Title){
		super(Title);
	 ...
	 //adding button 
	  btnGenCodeDlmToDlm = new JButton("Generate Code");
	  ...
	  //setting layout for  btnGenCode
	   SpringLayout.Constraints btnGenCodeCons =
		   layout.getConstraints(btnGenCodeDlmToDlm);
	   ...
	   setSize(700,650);
	     ...
	     GuiScripterDlmToDlmEvntHandler scripterDlmToDlm = new
	      GuiScripterDlmToDlmEvntHandler(this); 
	  
	     btnGenCodeDlmToDlm.addActionListener(scripterDlmToDlm);
	     
	     GuiScripterDlmToDlmAdapter adapterScripterDlmToDlm = 
	   	 new GuiScripterDlmToDlmAdapter(this);
	    this.addWindowListener(adapterScripterDlmToDlm); 
